...
class _TripMealDetailsPageState extends ConsumerState<TripMealDetailsPage> {
  ...
  List<String> _potluckItems = const [];
  ...
  Future<void> _addPotluckItem() async {
    ...
    setState(() => _potluckItems = [..._potluckItems, trimmed]);
  }

  Future<void> _editPotluckItem(int index) async {
    final l10n = AppLocalizations.of(context)!;
    final controller = TextEditingController(text: _potluckItems[index]);
    final value = await showDialog<String>(
      context: context,
      builder: (dialogContext) => AlertDialog(
  ...
  Future<void> _showMealModeHelp(BuildContext context) async {
    final l10n = AppLocalizations.of(context)!;
    await showDialog<void>(
      context: context,
      builder: (dialogContext) {
        return AlertDialog(
          title: Text(l10n.mealModesTitle),
          content: Column(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                tooltip: l10n.mealModeHelpTooltip,
                                onPressed: () => _showMealModeHelp(context),
                        ...
                        if (_activeMealView == _MealDetailsView.cooked) ...[
                          ...
                          const SizedBox(height: 8),
                          if (_restaurantUrlController.text.trim().isEmpty)
                            Text(
                            ...
                            LinkPreviewCardFromFirestore(
                              url: _restaurantUrlController.text.trim(),
                              preview: const {},
                            ),
                        ] else ...[
                          Row(
                          ...
                          if (_potluckItems.isEmpty)
                            ...
                            ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                return ListTile(
                                  contentPadding: EdgeInsets.zero,
                                  title: Text(_potluckItems[index]),
                                  trailing: Wrap(
                                    spacing: 4,
                                    children: [
                                      IconButton(
...
class _MealModeLegendRow extends StatelessWidget {
  const _MealModeLegendRow({
    required this.icon,
    required this.label,
  });
